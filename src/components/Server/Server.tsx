export const Server = () => (
    <div style={{display: 'flex', flexDirection: 'column'}}>
      <h1>- DRK.GDN -</h1>
      <ul style={{padding: 0, marginTop: '20px', listStyle: 'none', fontFamily: 'monospace', fontSize: '1.2rem', textAlign: 'center'}}>
        <li><a href='https://stats.drk.gdn'>stats</a></li>
        <li><a href='https://docker.drk.gdn'>docker</a></li>
        <li><a href='https://console.storage.drk.gdn'>storage</a></li>
